...
class StrategyLearner(object):
	...
	self.learner = ql.QLearner(num_states = 3000, num_actions = 3, alpha = 0.2, gamma = 0.9, rar = 0.5, radr = 0.99, dyna = 0, verbose = False)
...
def test_code():
    ...
    learner1 = StrategyLearner(verbose = False, impact = 0)
    learner1.addEvidence(symbol="AAPL",sd=dt.datetime(2008,1,1),ed=dt.datetime(2009,12,31),sv=100000)
    learner_trade1 = learner1.testPolicy(symbol = 'AAPL', sd = dt.datetime(2011,1,1), ed = dt.datetime(2012,12,31), sv = 100000)
    learner_val1, BM_port = market.compute_portvals(orderfile = learner_trade1, start_val = sv, commission = 0, impact = 0)
    print learner_val1, BM_port
