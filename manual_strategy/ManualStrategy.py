...
def testPolicy(symbols, sd = dt.datetime(2008,1,1), ed = dt.datetime(2009,12,31), sv = 100000):
    sma = indic.calSMA(symbols, start_date = sd, end_date = ed, period = 20)
    BB = indic.calBB(symbols, start_date = sd, end_date = ed, period = 20)
    MACD = indic.calMACD(symbols, start_date = sd, end_date = ed, low_period = 12, high_period = 26, signal = 9)
